...
enum PulPageId {
    ...
    PULPAGE_MAX = PULPAGE_BUTTONREMAP - PULPAGE_INITIAL + 1
};
...
enum BMG {
    ...
    BMG_VS_WW_MENU = 0x2855,
    BMG_OTHER_VS_MENU = 0x2856,
    BMG_200CC_VANZA_VS = 0x2857,
    BMG_VANZA_VS = 0x2858,
    BMG_VS_RESTORE = 0x2859,
    BMG_BATTLE_RESTORE = 0x285a,
    BMG_200CC_VANZA_VS_DESC = 0x285b,
    ...
    BMG_KICK_BOTTOM = 0x2920,    // ← aggiungi
    BMG_KICK_CONFIRM = 0x2921,   // ← aggiungi
    BMG_VKWW_START_MESSAGE = 0x6920,   // ← aggiungi
    BMG_OTTWW_START_MESSAGE = 0x6921,   // ← aggiungi
    BMG_ITEMRAIN_WW_START_MESSAGE = 0x6922,
    BMG_ITEMRAIN_VS_START_MESSAGE = 0x6923,
    BMG_ITEMRAIN_TEAM_VS_START_MESSAGE = 0x6924,
    BMG_MOGI_START_MESSAGE = 0x6926,

    BMG_WWMENU_MAIN_VS = 0x6930,
    BMG_WWMENU_MAIN_VS_DESC = 0x6931,
    BMG_WWMENU_MAIN_OTHER = 0x6932,
    BMG_WWMENU_MAIN_OTHER_DESC = 0x6933,
    BMG_WWMENU_VS_VANZA = 0x6934,
    BMG_WWMENU_VS_VANZA_DESC = 0x6935,
    BMG_WWMENU_VS_200CC = 0x6936,
    BMG_WWMENU_VS_200CC_DESC = 0x6937,
    BMG_WWMENU_OTHER_OTT = 0x6938,
    BMG_WWMENU_OTHER_OTT_DESC = 0x6939,
    BMG_WWMENU_OTHER_ITEMRAIN = 0x693a,
    BMG_WWMENU_OTHER_ITEMRAIN_DESC = 0x693b,

    // WW / Regional message and title BMG IDs
